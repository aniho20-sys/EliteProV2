...
export const sampleWorkoutPlans = [
  {
    ...
    day: 'Monday',
    exercises: [
      { exerciseId: 'bench-press', sets: 4, reps: '8-10', weight: 75, notes: 'Controlled tempo' },
      { exerciseId: 'barbell-row', sets: 4, reps: '8-10', weight: 60, notes: '' },
      { exerciseId: 'overhead-press', sets: 3, reps: '10-12', weight: 30, notes: 'Light weight due to shoulder' },
      { exerciseId: 'lat-pulldown', sets: 3, reps: '10-12', weight: 50, notes: '' },
      { exerciseId: 'barbell-curl', sets: 3, reps: '12', weight: 25, notes: '' },
      { exerciseId: 'tricep-pushdown', sets: 3, reps: '12', weight: 20, notes: '' },
    ],
  },
  {
    id: 'plan-2',
    ...
    day: 'Wednesday',
    exercises: [
      { exerciseId: 'squat', sets: 4, reps: '6-8', weight: 100, notes: 'Focus on depth' },
      { exerciseId: 'romanian-deadlift', sets: 3, reps: '10-12', weight: 80, notes: '' },
      { exerciseId: 'leg-press', sets: 3, reps: '12-15', weight: 120, notes: '' },
      { exerciseId: 'leg-curl', sets: 3, reps: '12', weight: 40, notes: '' },
      { exerciseId: 'calf-raise', sets: 4, reps: '15-20', weight: 60, notes: '' },
      { exerciseId: 'plank', sets: 3, reps: '60s', weight: 0, notes: '' },
    ],
  },
  {
    id: 'plan-3',
    ...
    day: 'Tuesday',
    exercises: [
      { exerciseId: 'squat', sets: 3, reps: '12-15', weight: 16, notes: 'Goblet squat OK' },
      { exerciseId: 'push-up', sets: 3, reps: '10-12', weight: 0, notes: 'Knees if needed' },
      { exerciseId: 'lat-pulldown', sets: 3, reps: '12', weight: 35, notes: '' },
      { exerciseId: 'lunge', sets: 3, reps: '12 each', weight: 10, notes: '' },
      { exerciseId: 'plank', sets: 3, reps: '30-45s', weight: 0, notes: '' },
      { exerciseId: 'cable-crunch', sets: 3, reps: '15', weight: 20, notes: '' },
    ],
  },
];
