...
// Set true to also show the legacy totalSessions / sessionOffset management UI
// alongside the credit system. Same flag pattern as CREDIT_PUSH_NOTIFICATIONS_ENABLED.
const LEGACY_SESSIONS_UI_ENABLED = false;
...
export default function ClientDetailPage() {
  ...
  // Legacy Sessions UI state (used only when LEGACY_SESSIONS_UI_ENABLED = true)
  ...
  // Legacy session stats — kept for LEGACY_SESSIONS_UI_ENABLED path and backward compat
  ...
  return (
    <div>
      ...
      {tab === 'overview' && (
        ...
        <div className="grid-2">
          ...
          <div className="card">
            ...
            {/* Legacy Sessions UI (totalSessions / sessionOffset) */}
            {LEGACY_SESSIONS_UI_ENABLED && (
              <div className="mt-16">
                <div className="flex-between mb-8" style={{ alignItems: 'center' }}>
      ...
      {/* Legacy Top Up modal (totalSessions system) */}
      {LEGACY_SESSIONS_UI_ENABLED && topUpOpen && (
