...
| **B13** | 🔴 **Phase 3 Step 3 真機驗收（學生訂閱）** | 2026-09-23 | commit 00185b3 | 要一個連住 Ani 嘅測試學生帳戶（唔好用真學生）。Ani：個人檔案設每堂收費 → 學生頁撳「標記為測試者」→ 用測試學生登入撳訂閱 → GoCardless sandbox 填測試銀行（20-00-00 / 55779911）→ 返嚟見「已啟用」。**完成標準：測試學生張卡顯示已啟用 + 月費金額。** 注意：堂數要 Step 4 先會自動加 |
